        ...
        <section className="ops-grid">
          ...
          <article className="panel execution-detail-panel">
            ...
            {execution.task.approvals.length === 0 ? <div className="separation-rule">No approvals for this task.</div> : execution.task.approvals.map((approval) => (
              <div className="detail-list execution-detail-list" key={approval.id}>
          ...
          <article className="panel execution-detail-panel" style={{ gridColumn: '1 / -1' }}>
            ...
            <div className="timeline execution-detail-timeline">
              {events.map((event) => {
