      ...
      <div className="settings-github-page">
        ...
        <section className="ops-grid">
          ...
          <article className="panel">
            ...
            <div className="github-boundary-copy">
              <p><strong>Implementation identity:</strong> branch creation, assigned-branch writes, draft PR creation.</p>
              <p><strong>Review identity:</strong> read diff, comment, approve/deny under separate credentials.</p>
              <p><strong>Merge:</strong> denied to implementation agents by default.</p>
              <p><strong>Audit:</strong> every GitHub API operation is persisted with task, execution, agent, repository, policy version, and result.</p>
            </div>
          </article>
        </section>
